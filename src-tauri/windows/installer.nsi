...
UninstPage custom un.ModesPage_Show un.ModesPage_Leave
UninstPage custom un.CheckboxPage_Show un.CheckboxPage_Leave
...
Function un.ModesPage_Show
  ...
  !insertmacro MUI_HEADER_TEXT "卸載 Capture2Text Pro" "選擇要如何卸載"
  ${NSD_CreateLabel} 0 0 100% 12u "請選擇卸載模式："
  Pop $0
