...
pub fn run() {
    ...
    let app = builder
        .setup(|app| {
            ...
            std::thread::spawn(move || {
                if let Err(err) = crate::llama_runtime::bootstrap(
                    crate::llama_runtime::manifest::ModelId::Qwen35_9b,
                ) {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            window_state::set_save_capture_original,
            window_state::set_save_capture_translated,
            ...
            commands::hotkey::get_hotkey_config,
            commands::hotkey::set_hotkey_config,
            commands::hotkey::reset_hotkey_default,
